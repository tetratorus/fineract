...
public interface AppUserRepository extends JpaRepository<AppUser, Long>, JpaSpecificationExecutor<AppUser>, PlatformUserRepository {
    ...
    @Query("""
            ...
            where appUser.oidcIssuer = :issuer and appUser.oidcSubject = :subject and appUser.deleted = false
            """)
    AppUser findByOidcIdentity(@Param("issuer") String issuer, @Param("subject") String subject);
}
