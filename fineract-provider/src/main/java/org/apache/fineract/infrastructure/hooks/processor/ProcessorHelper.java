...
public final class ProcessorHelper {
    ...
    private OkHttpClient createClient() {
        var okBuilder = new OkHttpClient.Builder().followRedirects(false).followSslRedirects(false).dns(urlValidator.dns());
        if (insecureHttpClient) {
     ...
     *             if the URL is not a permitted webhook destination
     */
